...
//
// This also tells the A side how large of a window to use for the reliability
// protocol.
...
//
// This also tells the B side how large of a window to use for the reliability
// protocol.
